package com.sai.test.localtestservice;
...
public class LocalTestService extends Service {
    ...
    public LocalTestService() {
        Log.e("LocalTestService", "Instantiate LocalTestService");
